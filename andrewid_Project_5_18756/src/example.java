...
public class example {
    ...
    public void go() {
        ...
        r1.allocateBandwidth(2, GlobalVariables.PHB_EF, 0, 5);
        r1.allocateBandwidth(2, GlobalVariables.PHB_AF, 1, 5);
        r1.allocateBandwidth(2, GlobalVariables.PHB_AF, 2, 4);
        r1.allocateBandwidth(2, GlobalVariables.PHB_AF, 3, 8);
        r1.allocateBandwidth(2, GlobalVariables.PHB_BE, 0, 0);
