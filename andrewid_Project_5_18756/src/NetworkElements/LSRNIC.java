...
public class LSRNIC {
    ...
    private int remainedBandwidth = linerate;
    public int EF = 0;
    public int AF1 = 1;
    public int AF2 = 2;
    public int AF3 = 3;
    public int AF4 = 4;
    public int BE = 5;
    private ArrayList<Queue<Packet>> queues = new ArrayList<Queue<Packet>>();
    ...
    public LSRNIC(LSR parent) {
        ...
        queues.add(0, new LinkedList<Packet>());
        queues.add(1, new LinkedList<Packet>());
        queues.add(2, new LinkedList<Packet>());
        queues.add(3, new LinkedList<Packet>());
        queues.add(4, new LinkedList<Packet>());
        queues.add(5, new LinkedList<Packet>());
...
//            queues.get(currentPacket.getClasses()).add(currentPacket);
//            return;
//        }
//        else{
...
//    public boolean reserveBandwidth(Packet packet) {
//        if (packet.getBandwidth() > this.remainedBandwidth) {
//            return false;
//        }
//        remainedBandwidth -= packet.getBandwidth();
//        return true;
//    }
